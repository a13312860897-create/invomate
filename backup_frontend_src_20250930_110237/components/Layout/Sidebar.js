...
import { FiFileText, FiUsers, FiPlus, FiChevronDown, FiChevronRight, FiDollarSign, FiFile, FiTrendingUp, FiPieChart, FiLink } from 'react-icons/fi';
  ...
  const navigation = [
    ...
    },
    {
      ...
      children: [
        ...
        { name: t('navigation:refund'), href: `/${t('routes:refund')}` },
      ],
    },
  ];
